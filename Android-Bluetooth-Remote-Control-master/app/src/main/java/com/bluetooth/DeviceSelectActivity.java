...
import com.bluetooth.activities.SendData;
...
public class DeviceSelectActivity extends Activity implements Handler.Callback
{
	...
	final OnItemClickListener deviceClickListener = new OnItemClickListener()
	{
		public void onItemClick(AdapterView<?> parent, View view, int position, long id)
		{
			...
			connectionProgressDialog = ProgressDialog.show(DeviceSelectActivity.this, "", "Estableciendo Conexi\u00f3n...", false, true);
			connectionProgressDialog.setOnCancelListener(new OnCancelListener()
			{
				public void onCancel(DialogInterface di)
				{
					...
					appState.disconnect();
					if(BluetoothRemoteControlApp.D) Log.i(TAG, "Cancelado progreso de conexi\u00f3n");
					return;
				}
			});
	...
	public boolean handleMessage(Message msg)
	{
		...
		case BluetoothRemoteControlApp.MSG_CONNECTED:
			...
			if(BluetoothRemoteControlApp.D) Log.i(TAG, "Conexi\u00f3n establecida de " + msg.obj);
